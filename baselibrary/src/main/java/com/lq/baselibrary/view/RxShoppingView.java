package com.lq.baselibrary.view;
...
public class RxShoppingView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typeArray = getContext().obtainStyledAttributes(attrs, R.styleable.base_ShoppingView);
        mDuration = typeArray.getInt(R.styleable.base_ShoppingView_base_sv_duration, DEFAULT_DURATION);
        mShoppingText = TextUtils.isEmpty(typeArray.getString(R.styleable.base_ShoppingView_base_sv_text)) ? DEFAULT_SHOPPING_TEXT :
                typeArray.getString(R.styleable.base_ShoppingView_base_sv_text);
        //展示文案大小
        int textSize = (int) typeArray.getDimension(R.styleable.base_ShoppingView_base_sv_text_size, sp2px(16));
        //背景色
        int bgColor = typeArray.getColor(R.styleable.base_ShoppingView_base_sv_bg_color, ContextCompat.getColor(getContext(), R.color.base_slateblue));
        typeArray.recycle();
