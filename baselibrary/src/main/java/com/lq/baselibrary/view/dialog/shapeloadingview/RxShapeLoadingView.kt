...
class RxShapeLoadingView : FrameLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.base_RxShapeLoadingView)
        mLoadText = typedArray.getString(R.styleable.base_RxShapeLoadingView_base_loadingText)
        mTextAppearance = typedArray.getResourceId(R.styleable.base_RxShapeLoadingView_base_loadingTextAppearance, -1)
        typedArray.recycle()
    }
    ...
    override fun onFinishInflate() {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.base_dialog_shape_loading_view1, null)
