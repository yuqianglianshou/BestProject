package com.lq.baselibrary.view.dialog.shapeloadingview
...
class RxShapeView : View {
    ...
    private fun init() {
        mPaint = Paint()
        mPaint!!.color = resources.getColor(R.color.base_triangle)
        mPaint!!.isAntiAlias = true
        mPaint!!.style = Paint.Style.FILL_AND_STROKE
        setBackgroundColor(resources.getColor(R.color.base_transColor))
        mTriangleColor = resources.getColor(R.color.base_triangle)
        mCircleColor = resources.getColor(R.color.base_circle)
        mRectColor = resources.getColor(R.color.base_pink_acfun)
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when (shape) {
            ...
            Shape.SHAPE_CIRCLE -> if (mIsLoading) {
                ...
                mPaint!!.color = resources.getColor(R.color.base_circle)
                val path = Path()
            ...
            Shape.SHAPE_RECT -> if (mIsLoading) {
                ...
                mPaint!!.color = resources.getColor(R.color.base_rect)
