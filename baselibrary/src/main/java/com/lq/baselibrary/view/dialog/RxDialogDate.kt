...
import com.lq.baselibrary.view.dialog.wheel.NumericWheelAdapter
import com.lq.baselibrary.view.dialog.wheel.OnWheelChangedListener
import com.lq.baselibrary.view.dialog.wheel.WheelView
...
class RxDialogDate : RxDialog {
    ...
    private fun build() {
        ...
        val dialogView1 = LayoutInflater.from(mContext).inflate(R.layout.base_dialog_year_month_day, null)
        ...
        yearView.setBackgroundResource(R.drawable.bg_transparent)
        yearView.setWheelBackground(R.drawable.bg_transparent)
        yearView.setWheelForeground(R.drawable.base_wheel_val_holo)
        ...
        monthView.setBackgroundResource(R.drawable.bg_transparent)
        monthView.setWheelBackground(R.drawable.bg_transparent)
        monthView.setWheelForeground(R.drawable.base_wheel_val_holo)
        ...
        dayView.setBackgroundResource(R.drawable.bg_transparent)
        dayView.setWheelBackground(R.drawable.bg_transparent)
        dayView.setWheelForeground(R.drawable.base_wheel_val_holo)
