package com.lq.baselibrary.view.dialog.loadingview
...
import com.lq.baselibrary.view.dialog.loadingview.SpriteFactory.create
...
class SpinKitView @TargetApi(Build.VERSION_CODES.LOLLIPOP) constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) : ProgressBar(context, attrs, defStyleAttr, defStyleRes) {
    ...
    @JvmOverloads
    constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.base_SpinKitViewStyle) : this(context, attrs, defStyleAttr, R.style.base_SpinKitView)
    ...
    init {
        val a = context.obtainStyledAttributes(attrs, R.styleable.base_SpinKitView, defStyleAttr,
                defStyleRes)
        mStyle = Style.values()[a.getInt(R.styleable.base_SpinKitView_base_SpinKit_Style, 0)]
        color = a.getColor(R.styleable.base_SpinKitView_base_SpinKit_Color, Color.WHITE)
        a.recycle()
        init()
