package com.lq.baselibrary.view.dialog.wheel
...
class WheelView : View {
    ...
    // Wheel drawables
    private var wheelBackground = R.drawable.base_bg_wheel
    private var wheelForeground = R.drawable.base_wheel_val_holo
    ...
    /**
     * Set the base_shadow gradient color
     * @param start
     * @param middle
     * @param end
     */
